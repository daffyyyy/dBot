...
class Cache {
    ...
    private $_salt = "dsad34gfs2435"; // <-- change before usage!
    ...
    public function __construct(string $name = "default", string $dir = "includes/tmp/", string $extension = ".cache") {

        if(md5($this->_salt) == "bbbb2edef660739a6071ab5a4f8a869f") throw new Exception("Change _salt value before usage! (line 5)");
